...
for name, model in models.items():
    try:
        ...
        print(f"{name:25} | MSE: {mse/1e6:>15.2f} mln | RMSE: {rmse:>10.2f} | R2: {r2:.3f}")
...
if results:
    ...
    joblib.dump(final_pipeline, 'fifa_value_predictor.pkl')
    print(f"\nZapisano najlepszy model ({best_model_name}) do pliku 'fifa_value_predictor.pkl'")
else:
